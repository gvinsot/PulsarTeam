...
class SandboxBackend(RunnerBackend):
    ...
    async def run_sync(self, prompt, system_prompt=None, agent_id=None, owner_id=None, task_id=None) -> dict:
        return {
            "status": "error",
            "output": "",
    ...
    async def stream_events(self, prompt, system_prompt=None, agent_id=None, owner_id=None, task_id=None) -> AsyncIterator[dict]:
        yield {
            "type": "error",
