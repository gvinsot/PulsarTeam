...
export default function AddAgentModal({
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      const batchSize =
        payload.isBatch && !payload.isVoice
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <h3 className="font-semibold text-dark-100 mb-1 group-hover:text-indigo-400 transition-colors">
                    From Template
                  </h3>
                  <p className="text-xs text-dark-400">
                    Choose from pre-configured agent templates for common roles
                  </p>
                </button>
                <button
                ...
                >
                  <div className="text-3xl mb-3">⚡</div>
                  <h3 className="font-semibold text-dark-100 mb-1 group-hover:text-purple-400 transition-colors">
                    Custom Agent
                  </h3>
                  <p className="text-xs text-dark-400">
                    Configure everything from scratch with full control
                  </p>
                </button>
              </div>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        ...
                        <span className="text-[11px] text-dark-400 capitalize">
                          {template.role}
                        </span>
                      </div>
                    </div>
              ...
              {selectedTemplate && (
                <div className="flex items-center gap-2 px-3 py-2 bg-indigo-500/10 border border-indigo-500/20 rounded-lg text-xs text-indigo-400">
                  ...
                  <button
                    ...
                    className="ml-auto hover:text-indigo-300"
                  >
                    Change
                  </button>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="col-span-2">
                  ...
                  >
                    ...
                    {projects.map(p => (
                      <option
                        key={p.name}
                        value={p.name}
                        title={p.description || p.htmlUrl || p.name}
                      >
                        {p.fullName || p.name}
                      </option>
                    ))}
                  ...
                  <p className="text-[11px] text-dark-500 mt-1">
                    Pick the git repository this agent will clone into its runner container
                  </p>
                </div>
                ...
                <div className="col-span-2">
                  <label
                    className={`flex items-center gap-3 group ${form.isVoice ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}`}
                  >
                    <input
                      type="checkbox"
                  ...
                  <p className="text-[11px] text-dark-500 mt-1 ml-7">
                    {form.isVoice
                      ? 'Locked — Voice agents are always leaders'
                      : 'Leader agents orchestrate and coordinate other agents in the swarm'}
                  </p>
                </div>
                ...
                {(!selectedTemplate || selectedTemplate.isLeader || selectedTemplate.isVoice) && (
                  <div className="col-span-2">
                    ...
                    <p className="text-[11px] text-dark-500 mt-1 ml-7">
                      Forces Leader mode. Pick the voice pipeline below.
                    </p>
                  </div>
                )}
                ...
                {form.isVoice && form.voiceMode === 'external' && (
                  <div className="col-span-2">
                    ...
                    />
                    <p className="text-[11px] text-dark-500 mt-1">
                      Voice ID sent to the TTS service. Falls back to the global default in Admin
                      Settings.
                    </p>
                  </div>
                )}
                ...
                {!form.isVoice && (
                  <div className="col-span-2 border-t border-dark-700 pt-4">
                    ...
                    <p className="text-[11px] text-dark-500 mt-1 ml-7">
                      Spawn several identical agents at once. The Agents view collapses a batch into
                      a single card with a member dropdown.
                    </p>
                    {form.isBatch && (
                      <div className="mt-3 ml-7">
                        ...
                        />
                        <p className="text-[11px] text-dark-500 mt-1">
                          2–50. Each will be named "{form.name || 'Agent'} #1", #2, …
                        </p>
                      </div>
                    )}
                  </div>
