...
const SLACK_CONFIG: OAuthProviderConfig = {
  ...
  configuredHint: (
    <>
      Set <code className="text-dark-400">SLACK_CLIENT_ID</code>,{' '}
      <code className="text-dark-400">SLACK_CLIENT_SECRET</code>, and{' '}
      <code className="text-dark-400">SLACK_REDIRECT_URI</code> environment variables to enable.
    </>
  ),
  connectHint: agentId =>
    agentId
