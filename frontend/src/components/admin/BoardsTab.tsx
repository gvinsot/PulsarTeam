...
export default function BoardsTab({ active, showToast }) {
  ...
  const addBoardColumn = () => {
    ...
    setBoardForm(f => ({
      ...f,
      columns: [...f.columns, { id, label: 'New Column', color: '#6b7280' }],
    }));
  };
    ...
    <>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              {boardForm.columns.length === 0 && (
                <div className="text-center py-3 text-xs text-dark-500">
      ...
      <div className="p-4 bg-dark-800/50 rounded-xl border border-dark-700">
        <p className="text-xs text-dark-400">
          Boards organize tasks into workflow columns. Each board can have its own set of columns,
          transitions, and assigned agents. Agents attached to a board will only process tasks from
          that board.
        </p>
      </div>
    </>
