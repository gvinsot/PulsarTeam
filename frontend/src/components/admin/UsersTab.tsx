    ...
    <>
      ...
      {showCreateForm && (
        <form
          ...
          className="p-4 bg-dark-800 rounded-xl border border-dark-700 space-y-4"
        >
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              type="submit"
              className="flex items-center gap-1 px-3 py-1.5 bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg text-sm font-medium transition-colors"
            >
      ...
      {editingUser && (
        <form
          ...
          className="p-4 bg-dark-800 rounded-xl border border-indigo-500/30 space-y-4"
        >
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0">
                  <div className="relative flex-shrink-0">
                    ...
                    <span
                      className={`absolute -bottom-0.5 -right-0.5 w-2 h-2 rounded-full border border-dark-800 ${user.is_online ? 'bg-green-400' : 'bg-dark-600'}`}
                    />
                  </div>
                  ...
                  <span className={`text-[10px] px-1 py-0.5 rounded ${rc.bg} ${rc.color}`}>
                    {rc.label}
                  </span>
                </div>
                <div className="flex items-center gap-2 flex-shrink-0">
                  <span
                    className={`text-[11px] ${user.is_online ? 'text-green-400' : 'text-dark-500'}`}
                  >
